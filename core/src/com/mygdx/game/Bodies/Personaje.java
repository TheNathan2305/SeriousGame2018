...
public class Personaje extends Image {
    ...
    public Personaje(World aWorld, float pos_x, float pos_y){
        super(new Texture("personaje.png"));
      ...
      //  shape.setAsBox(this.getWidth()/2, this.getHeight()/2);
       ...
       // fixtureDef.shape = shape;
        ...
        fixtureDef.filter.categoryBits= Constants.CATEGORY_PERSONAJE; //is a
        fixtureDef.filter.maskBits=(short) (Constants.CATEGORY_BLOODSTREAM|Constants.CATEGORY_ENEMIES);//collides with
        fixtureDef.filter.groupIndex=0;


        loader.attachFixture(body, "personaje", fixtureDef,getWidth());
